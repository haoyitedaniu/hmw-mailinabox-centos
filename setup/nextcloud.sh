...
nextcloud_ver=25.0.2
nextcloud_hash=68890ece4b7ae15b0cff653913e9d36f47b259b7
...
#   copying it from the error message when it doesn't match what is below.
contacts_ver=5.0.0
contacts_hash=53b5b6bb6bcc8e3cc67900d760861f9babf5d024
#ca13d608ed8955aa374cb4f31b6026b57ef88887
calendar_ver=4.1.2
calendar_hash=7fe1fbc5e39070b3511624e20574559bf31814f6
#c8136a3deb872a3ef73ce1155b58f3ab27ec7110
user_external_ver=3.1.0
user_external_hash=22cabc88b6fc9c26dad3b46be1a652979c9fcf15
#0df781b261f55bbde73d8c92da3f99397000972f
...
#tools/editconf.py /etc/php/mods-available/apcu.ini -c ';' \
tools/editconf.py /etc/php.d/40-apcu.ini -c ';' \
	apc.enabled=1 \
	apc.enable_cli=1

tools/editconf.py /etc/php-zts.d/40-apcu.ini -c ';' \
        apc.enabled=1 \
        apc.enable_cli=1
...
#tools/editconf.py /etc/php-fpm/php.ini -c ';' \
...
#tools/editconf.py /etc/php/cli/conf.d/10-opcache.ini -c ';' \
